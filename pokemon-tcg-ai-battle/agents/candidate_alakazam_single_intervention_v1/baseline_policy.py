...
IONO_TARGET_PRIORITY = {
    270: 80,  # Iono's Wattrel: Kilowattrel base
    268: 80,  # Iono's Tadbulb: Bellibolt ex base
    265: 55,  # Iono's Voltorb
}
...
def iono_target_priority(pokemon: Pokemon) -> int:
    return IONO_TARGET_PRIORITY.get(pokemon.id, 0)
